...
int main(){
    ...
    if(seq!=-1) 
        printf("Student Roll No. %d found by Sequential Search.\n",key);
    else 
        printf("Student Roll No. %d not found by Sequential Search.\n",key);
    if(bin!=-1) 
        printf("Student Roll No. %d found by Binary Search.\n",key);
    else 
        printf("Student Roll No. %d not found by Binary Search.\n",key);
